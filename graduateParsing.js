...
jsonData.map((data, index) => {
  if (index < 1) {
    // console.log('empty');
  } else if(index >=1 && index <265) {
    data['균형교양필수영역'] = data['균형교양필수영역'].replace('\r\n','');
    data['균형교양필수영역'] = data['균형교양필수영역'].replace('역사와 사상','사상과역사');
    data['균형교양필수영역'] = data['균형교양필수영역'].replace('자연과 과학','자연과과학기술');
    data['균형교양필수영역'] = data['균형교양필수영역'].replace('경제와 사회','사회와문화');
    data['균형교양필수영역'] = data['균형교양필수영역'].replace('문화와 예술','예술과체육');
